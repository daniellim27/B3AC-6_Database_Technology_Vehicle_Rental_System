...
<div class="card mb-6">
    <div class="card-header d-flex align-items-center justify-content-between">
        ...
        <small class="text-muted float-end">Insurance Record Edit Form</small>
    </div>
    <div class="card-body">
        ...
        <form action="/insurance/<?= $insurance->insurance_id ?>/edit" method="post">
            <?= csrf_field() ?>

            <!-- Insurance ID (readonly) -->
            <div class="row mb-4">
                ...
                <div class="col-sm-10">
                    <select
                        ...
                        <?php foreach ($vehicles as $id => $name): ?>
                            <option value="<?= $id ?>" <?= $insurance->vehicle_id == $id ? 'selected' : '' ?>>
                                <?= esc($name) ?>
                            </option>
                        <?php endforeach ?>
                    </select>
            ...
            <div class="row mb-4">
                ...
                <div class="col-sm-10">
                    <input
                        ...
                        value="<?= $insurance->coverage_start_date ?>" />
                    <div class="invalid-feedback">
            ...
            <div class="row mb-4">
                ...
                <div class="col-sm-10">
                    <input
                        ...
                        value="<?= $insurance->coverage_end_date ?>" />
                    <div class="invalid-feedback">
            ...
            <div class="row justify-content-end">
                <div class="col-sm-10">
                    <button type="submit" class="btn btn-primary">Update Insurance Record</button>
