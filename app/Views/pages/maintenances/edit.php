...
<div class="card mb-6">
    <div class="card-header d-flex align-items-center justify-content-between">
        ...
        <small class="text-muted float-end">Maintenance Record Edit Form</small>
    </div>
    <div class="card-body">
        ...
        <form action="/maintenances/<?= $maintenance->maintenance_id ?>/edit" method="post">
            <?= csrf_field() ?>
                ...
                <div class="col-sm-10">
                    <select
                        ...
                        <?php foreach ($vehicles as $id => $name): ?>
                            <option value="<?= $id ?>" <?= $maintenance->vehicle_id == $id ? 'selected' : '' ?>>
                                <?= esc($name) ?>
                            </option>
                        <?php endforeach ?>
                    </select>
            ...
            <div class="row mb-4">
                ...
                <div class="col-sm-10">
                    <textarea
                        ...
                        rows="3"
                        maxlength="100"><?= $maintenance->maintenance_description ?></textarea>
                    <div class="invalid-feedback">
