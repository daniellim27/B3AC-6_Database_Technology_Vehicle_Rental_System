<div class="app-brand demo">
    <a href="index.html" class="app-brand-link">
        ...
        <span class="app-brand-text demo menu-text fw-semibold ms-2">Rental</span>
    </a>
</div>
...
<ul class="menu-inner py-1">
    ...
    <li class="menu-item">
        <a href="/dashboard" class="menu-link">
            ...
            <div data-i18n="Vehicles">Dashboard</div>
        </a>
    </li>
    ...
    <!-- Rentals -->
    <li class="menu-item">
        <a href="/rentals" class="menu-link">
            <i class="menu-icon tf-icons ri-calendar-line"></i>
            <div data-i18n="Rentals">Rentals</div>
        </a>
    </li>
    <!-- Payments -->
    <li class="menu-item">
    ...
    <!-- Maintenance -->
    <li class="menu-item">
        <a href="/maintenances" class="menu-link">
    ...
    <!-- Insurance -->
    <li class="menu-item">
        <a href="/insurance" class="menu-link">
